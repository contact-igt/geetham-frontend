                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-14 mb-24">
                    ...
                    <div className="lg:pl-8">
                        ...
                        <ul className="flex flex-col gap-4">
                            {QUICK_LINKS.map((l) => (
                                <li key={l.label}>
                                    <Link href={l.href} className="font-sans text-white/60 text-[1.05rem] font-medium hover:text-[#fb7185] transition-colors flex items-center gap-3.5 group">
                                        <span className="w-2 h-2 rounded-full bg-white/10 group-hover:bg-[#fb7185] transition-all group-hover:scale-125" />
                                        {l.label}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-4 mb-12">
                            {ROOM_TYPES.map((r) => (
                                <li key={r.label}>
                                    <Link href={r.href} className="font-sans text-white/60 text-[1.05rem] font-medium hover:text-[#fb7185] transition-colors flex items-center gap-3.5 group">
                                        <span className="w-2 h-2 rounded-full bg-white/10 group-hover:bg-[#fb7185] transition-all group-hover:scale-125" />
                                        {r.label}
                                    </Link>
                                </li>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-7">
                            {/* Phone */}
                            <a href="tel:+919344382988" className="flex items-start gap-4.5 group">
                                <div className="w-12 h-12 rounded-[1rem] border border-white/10 bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-[#e11d48]/15 group-hover:border-[#e11d48]/30 transition-all shadow-md">
                                    <Phone className="w-5 h-5 text-white/70 group-hover:text-[#fb7185] transition-colors" />
                                </div>
                                <div className="flex flex-col pt-0.5">
                                    <span className="font-sans text-white/95 font-bold text-[1.1rem] group-hover:text-[#fb7185] transition-colors block leading-tight">+91 93443 82988</span>
                                    <span className="font-sans text-white/60 font-medium text-[1rem] mt-1.5 group-hover:text-[#fb7185] transition-colors block">+91 98427 65530</span>
                                </div>
                            </a>

                            {/* Email */}
                            <a href="mailto:geethamhostel.in@gmail.com" className="flex items-start gap-4.5 group">
                                <div className="w-12 h-12 rounded-[1rem] border border-white/10 bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-[#e11d48]/15 group-hover:border-[#e11d48]/30 transition-all shadow-md">
